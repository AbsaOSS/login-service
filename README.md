...
If you wish to generate an accurate git.properties file, you can do so by setting the "loginsvc.rest.config.git-properties" to true.
...
This requires Git to be installed and available on the host. If failing, please disable the feature in your config (set "loginsvc.rest.config.git-properties" to false).
